...
def Scene():
    ...
    data_path = "datasets/scene15.mat"
    data = sio.loadmat(data_path)
    data_X = data['X'][0]
    data_Y = data['Y']
...
def Caltech():
    ...
    data_path = "datasets/Caltech101-20.mat"
    data = sio.loadmat(data_path)
    data_X = data['X'][0]
    data_Y = data['Y']
...
def CUB():
    # dims of views: 1000 300
    data_path = "datasets/CUB.mat"
    data = sio.loadmat(data_path)
    data_X = data['X'][0]
    data_Y = data['Y']
...
def NUS():
    # dims of views: 64 144 73 128 225 500
    data_path = "datasets/NUS.mat"
    data = sio.loadmat(data_path)
    data_X = data['X'][0]
    data_Y = data['Y']
    return MultiViewDataset("NUS", data_X, data_Y)
